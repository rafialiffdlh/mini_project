        ...
        <div className="text-gray-800">
          ...
          <ul className="list-disc list-inside mb-4">
            ...
            <li className="mb-2">
              ...
              berlangsung. Sehingga, event dengan jumlah penonton yang besar
          ...
          <p>
            Sudah ada ratusan event yang bekerja sama dengan kami dan tersebar
            di seluruh Indonesia. Kini, saatnya perkenalkan event Anda pada
